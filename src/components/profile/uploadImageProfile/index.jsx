...
function UploadImageProfile(props) {
  ...
  const { onFinish, profileId } = props;
  ...
  const handleUpload = useCallback(async () => {
    ...
    const url = `/mediaS3/upload-single/${profileId}`;
    try {
    ...
    onFinish();
  }, [files, onFinish, onShowMessage, profileId]);
...
export default memo(UploadImageProfile);
